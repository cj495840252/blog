                ...
                div { class: "m-auto md:w-8/12 lg:w-6/12 xl:w-6/12",
                    div { class: "rounded-xl bg-white shadow-xl",
                        div { class: "p-6 sm:p-16",
                            ...
                            div {
                                class: "mt-32 space-y-4 text-gray-600 text-center sm:-mb-8",
                                p { class: "text-xs",
                                    "By proceeding, you agree to our "
                                    a { href: "#", class: "underline", "Terms of Use" }
                                    " and confirm you have read our "
                                    a { href: "#", class: "underline", "Privacy and Cookie Statement" }
                                    "."
                                }
                                p { class: "text-xs",
                                    "This site is protected by reCAPTCHA and the "
                                    a { href: "#", class: "underline", "Google Privacy Policy" }
                                    " and "
                                    a { href: "#", class: "underline", "Terms of Service" }
                                    " apply."
                                }
                            }
                        }
