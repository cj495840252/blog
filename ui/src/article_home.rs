...
use crate::{model, ArticleCard};

#[component]
pub fn ArticleHomeLayout(articles: Vec<model::ArticleCard>) -> Element {
    rsx! {
        document::Link{ rel:"stylesheet", href: asset!("/assets/css/article_home.css")}

        div {
            class: "flex",

            div {
                class: "w-1/4 h-screen-4 bg-gray-200 p-8 flex flex-col items-center justify-center  relative top-1/3 transform -translate-y-1/3" ,
                style { background_color: "#f3f4f6" },
                img {
                    alt: "头像",
                    src: "assets/自己.jpg",
                    class: "h-14 rounded-full mb-6 shadow-md",
                }
                h1 { class: "text-2xl font-bold text-gray-800 mb-2", "陈佳" }
                p { class: "text-lg text-gray-600 mb-1", "大数据开发工程师" }
                p { class: "text-md text-gray-500 mb-6", "期望大数据开发或Rust相关" }
                div { class: "space-y-2 text-center",
                    p { class: "text-sm text-gray-600", "电话: 13403085904" }
                    p { class: "text-sm text-gray-600",
                        "邮箱:"
                        a {
                            href: "mailto:chenjia0101@foxmail.com",
                            class: "text-blue-500 hover:underline",
                            "chenjia0101@foxmail.com"
                        }
                    }
                    p { class: "text-sm text-gray-600",
                        "网站:"
                        a {
                            href: "https://www.zackjchen.com",
                            target: "_blank",
                            class: "text-blue-500 hover:underline",
                            "www.example.com"
                        }
                ...
                div {
                    ...
                    div { class: "border-b mb-5 flex justify-between text-sm",
                        div { class: "text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase",
                            ...
                            a { href: "#", class: "font-semibold inline-block", "BLog" }
                        }
                        a { href: "#", "See All" }
                    }
